    ...
    <section id="review" className="relative py-20 bg-black overflow-hidden">
      <div className="containerStyle">
        <h1 data-aos="fade-down" className="sectionTitleStyle">
          <span className="sectionTitleSpanStyle">Avaliações</span> dos Clientes
        </h1>
        <h2 className="sectionSubtitleStyle">
          Veja algumas das avaliações recentes de nossos clientes.
        </h2>
        <Swiper
          slidesPerView={1}
          modules={[Pagination]}
          ...
          {ReviewsData.map((review, index) => (
            <SwiperSlide key={index}>
              <div data-aos="zoom-in"
                ...
                <FaQuoteRight className="absolute -top-5 left-6 text-4xl text-(--secondary-color)" />
                ...
                <div className="flex gap-4 h-16 mt-4 items-center">
                  <div className="w-14 h-14 rounded-xl overflow-hidden ring-2 ring-(--secondary-color)/40">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-1">
                        <FaStar className="text-lg text-(--secondary-color)" />
                        <p className="text-lg font-bold text-(--secondary-color)">{review.rating.toFixed(1)}</p>
                      </div>
                    </div>
