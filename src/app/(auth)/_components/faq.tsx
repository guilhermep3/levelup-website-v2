  ...
  return (
    <section id="faq" className="relative py-20 bg-black overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <h1 data-aos="fade-down" className={sectionTitleStyle}><span className={sectionTitleSpanStyle}>Perguntas</span> frequentes</h1>
          ...
          {faqs.map(faq => (
            <div key={faq.id} data-aos="fade-down"
              ...
              <button onClick={() => handleShowAnswer(faq.id)}
                className={`w-full p-4 sm:p-5 flex justify-between items-center text-left font-semibold transition
								${showAnswer === faq.id ? "bg-[var(--primary-color)] text-black" : "bg-transparent text-white hover:bg-zinc-800"}`}>
                {faq.question}
