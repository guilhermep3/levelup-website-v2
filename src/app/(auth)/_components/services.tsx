        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 justify-items-center">
          {servicesData.map((service) => (
            <div data-aos="zoom-in">
              ...
              >
                <div className="absolute inset-0 z-[1] bg-gradient-to-t from-black/90 via-black/50 to-transparent"></div>
                ...
                <div className="relative z-[2] h-full p-5 flex flex-col justify-end">
                  <p className="text-3xl font-extrabold text-[var(--primary-color)]">
                    {service.title}
                  </p>
                  <p className="mt-2 text-sm text-zinc-300 leading-relaxed">
                    {service.text}
                  </p>
                  <div className="mt-6 flex items-center gap-2 w-fit px-4 py-2 rounded-full bg-zinc-800/80 backdrop-blur text-sm font-semibold transition-all group-hover:bg-[var(--primary-color)] group-hover:text-black">
                    Ver planos
